...
class database{
  ...
  public function deletereservatie($id, $klant_id){
    try{
      ...
      $stmt = $this->pdo->prepare("DELETE FROM factuur WHERE reservatie_id = '$id'");
      $stmt->execute();
      

      $stmt = $this->pdo->prepare("DELETE FROM etendrinken WHERE reservatie_id = '$id'");
      $stmt->execute();
  ...
  public function deletereservatiebar($id, $klant_id){
    try{
      ...
      // $this->pdo->beginTransaction();
      // delete foregin key of klant first
      $stmt = $this->pdo->prepare("DELETE FROM factuur_bar WHERE reservatie_bar_id = '$id'");
      $stmt->execute();
      

      $stmt = $this->pdo->prepare("DELETE FROM barorders WHERE reservatie_bar_id = '$id'");
      $stmt->execute();
