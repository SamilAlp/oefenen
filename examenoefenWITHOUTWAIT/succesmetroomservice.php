...
<body style="background: #6E6E6E">
  ...
  <div class="container"> 
      ...
      Nog bestellen?
       ...
       <br>
        <a href="restaurantofbar.php?reorder=yes&reservatie_id=<?php echo $id; ?>&naam=<?php echo $klant_name; ?>&naam_id=<?php echo $klant_id; ?>" style="font-size: 20px;" calss="text-danger"> Choose again!</a>  
       <br>
