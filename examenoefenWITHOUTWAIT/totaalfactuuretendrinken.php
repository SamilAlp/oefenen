...
<body style="background: #6E6E6E">
  ...
  <div class="container">
      ...
      <br>
        ...
        <a href="roomservice.php?reorder=yes&reservatie_id=<?php echo $id; ?>" style="font-size: 20px;" calss="text-danger"> Go back to reorder!</a>  
       <br>
        <a href="restaurantofbar.php?reorder=yes&reservatie_id=<?php echo $id; ?>&naam=<?php echo $klant_name; ?>&naam_id=<?php echo $klant_id; ?>" style="font-size: 20px;" calss="text-danger"> Choose the restaurant or bar again!</a>  
       <br>
  ...
  <div class="container"> 
      ...
      <div class="container">
        ...
        <br>
        <a href="bedankt.php" style="font-size: 20px;" calss="text-danger"> Bent u klaar? Bekijk onze nieuwe gerechten verder op onze site!</a>  
        <br>
        <br>
